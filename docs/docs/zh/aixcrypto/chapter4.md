...
<center>图 28：机器学习管道的三个主要步骤是数据、训练和推理</center>
...
<center>图35：这是一些强化学习代理在训练过程中的视频：一个[真正的机器人](https://www.youtube.com/watch?v=n2gE7n11h1Y)和一个[模拟机器人](https://www.youtube.com/watch?v=hx_bgoTF7bs) </center>
